...
FULL_BG = pygame.image.load('Assets/Other/night_dubai.jpg')
...
def eval_genomes(genomes, config):
    ...
    def statistics():
        ...
        text_1 = FONT.render("Dinosaurs: " + str(len(dinosaurs)), True, (23, 0, 255))
        text_2 = FONT.render("Game Speed: " + str(game_speed), True, (0, 255, 191))
        text_3 = FONT.render("Generation: " + str(pop.generation+1), True, (0, 56, 191))
